// To get the result of student by roll no using a member function of a student class.
#include<iostream>
using namespace std;
class Student{
    ...
    int i,roll2;char res;
     ...
     for(i=0;i<5;i++){
         if(roll2==obj[i].Rollno){
             ...
             cout<<"\n Marks obtained by student is "<<obj[i].Marks;
            cout<<"\n Result of student  is "<<obj[i].Result();
        }
     }  
    return 0;
}
